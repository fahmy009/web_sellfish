	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php">SellFish</a>
			</div>
	...
	<div class="container">
		...
		<table class="table" style="margin-top: 30px;">
			...
			<tr>
				...
				<td>
				<a href="?controller=keranjang&action=detailTransaksiPembeli&id_order=<?php echo $item['id_order']; ?>"> <button class="btn btn-primary"><span class="glyphicon glyphicon-eye-open"></span></button></a>
				</td>
