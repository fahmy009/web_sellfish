	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">SellFish</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Kelola ikan<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="?controller=produk&action=createProduk">Input data ikan</a></li>
							<li><a href="?controller=produk&action=showAllProdukPenjual">Lihat data ikan</a></li>
				...
				<?php foreach ($posts as $item) {
					...
					<form class="form" method="POST" enctype="multipart/form-data">
						...
						<div class="card" style="width: 50rem; height:auto; margin-bottom:30px;">
							...
							<div class="card-block">
								...
								<p class="card-text">
									...
									Jumlah stok : <?php echo $item['jumlah_stok']." "; ?>kg <br>
						...
						<div class="input-group">
							...
							<input name="nama_produk" type="text" class="form-control" placeholder="Masukkan nama ikan" aria-describedby="basic-addon1"
