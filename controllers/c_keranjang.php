...
public function detailTransaksiPembeli(){
	...
	if (isset($_SESSION['login_user'])) {
		$posts=Keranjang::detailTransaksiPembeli($_GET['id_order']);
...
public function detailTransaksiAdmin(){
	...
	if (isset($_SESSION['login_user'])) {
		$posts=Keranjang::detailTransaksiAdmin($_GET['id_order']);
...
public function editStatusTransaksi(){
	$posts=Keranjang::editStatusTransaksi($_GET['id_order']);
